...
2. Put `TotemSMP.jar` into your server's `plugins/` folder.
...
## GitHub Actions
Push the repository to GitHub, open **Actions**, select the build workflow, and download the `TotemSMP` artifact.
